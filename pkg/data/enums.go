...
func IsSuccessfulAgreementState(itemType uint8) bool {
	return itemType == GetAgreementStateIndex("ResultsAccepted") || itemType == GetAgreementStateIndex("MediationAccepted")
}
